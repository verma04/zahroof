    ...
    return (
        <Section>
           ...
           <div className="section" >
            ...
            <div dangerouslySetInnerHTML={{ __html: data.data.aboutfirstleftContent }} className="section2_data_left"  >
...
<div dangerouslySetInnerHTML={{ __html: data.data.aboutfirstrightContent }} className="section2_data_left"  >
