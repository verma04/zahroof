        ...
        <div className="section" > 
            <div className="section_bottom" >
                ...
                <div className="section2_data" > 
                    <div className="section2_data_left" dangerouslySetInnerHTML={{ __html: data.data.engineeringfirstleftcontent }} />
                    <div className="section2_data_right" dangerouslySetInnerHTML={{ __html: data.data.engineeringfirstrightcontent }} />                            
                </div>
            </div>
        </div>
