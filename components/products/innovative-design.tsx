...
<meta property="og:image" content="http://zahroofvalves.com/uploads/3/5/0/8/35082493/standardvalve_orig.jpg" />
<meta property="og:image" content="http://zahroofvalves.com/uploads/3/5/0/8/35082493/published/module-2dview.jpg?1564524021" />
...
<meta property="og:url" content="http://zahroofvalves.com/innovative-design.html" />
...
//-->
	...
	<body class=" text-header wsite-theme-light  wsite-page-innovative-design"><div class="design">
...
<div style="height:0px;overflow:hidden"></div></div></div>
	...
	<font color="#0085ca">Innovative Design</font>
</span></h2>
			</div>
			<div role="main">
...
<h2 style="text-align:left;"><font color="#0085ca">Reed Valve Modules with Straight-Through Flow Path</font></h2>
<span class='imgPusher' style='float:left;height:0px'></span><span style='position:relative;float:left;z-index:1;;clear:left;margin-top:0px;*margin-top:0px'><a href='/uploads/3/5/0/8/35082493/module-2dview_orig.jpg' rel='lightbox' onclick='if (!lightboxLoaded) return false'><img class="wsite-image galleryImageBorder" src="/uploads/3/5/0/8/35082493/published/module-2dview.jpg?1564524021" style="margin-top: 5px; margin-bottom: 10px; margin-left: 0px; margin-right: 10px; border-width:1px;padding:3px;" alt="Picture" /></a><div style="display: block; font-size: 90%; margin-top: -10px; margin-bottom: 10px; text-align: center;">Flow path through a valve module</div></span>
<div class="paragraph" style="display:block;">Each module is an enhanced reed valve, designed such that the flow path through the valve is straight-through with very low losses. The gas does not have to traverse the tortuous, high loss, path that is present in conventional poppet / plate / ring valves. This results in valves with the highest effective area for a given valve diameter. The effective area is increased even further with our StraightFlo high efficiency valves such as the Stacked Valve, Radial-Axial valve, Double deck valve and Parallel Flow valve.<br /><br />The flow path through the modules also make the valves highly tolerant to liquids and solids through the valves. When the reeds are wide open, liquids and solids go right through the module without any impact on the critical sealing faces of the modules. In the case of the plate, ring and poppet valves, any liquids or solids strike directly against the hot, highly stressed plastic plate, ring or poppet, causing them to break or for the particle to get embedded in it. This affects the sealing surface, requiring the valve to be serviced.&nbsp;<br /><br />The plastic components of the module are not highly stressed unlike the plates, rings and poppets of conventional valves, as they don't move and they don't impact the metal housings.<br /><br />&#8203;Since there are no moving masses impacting against the valve seat and guard, the vibration levels of a compressor operating with StraightFlo valves is typically 1/10th that of compressors with conventional valves and noise can be reduced by more than 7dB.<br /><br />Since the reeds acts as both the sealing element and the spring element, the lowest natural frequency of our modules is 250Hz. Well above any excitation force from an engine or motor. This also makes our valve suited to much higher speeds than is currently common in the field. Compare this with a maximum of 30Hz for poppet valves and about 80Hz for plate/ring valves where a mass (poppet/plate/ring) has helical coil springs supporting it.<br /><br /></div>
<hr style="clear:both;visibility:hidden;width:100%;"></hr>
</div>
</div>
			</div>
