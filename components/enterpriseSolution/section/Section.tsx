        ...
        <Section>
           ...
           <div className="section" >
               ...
               <div className="section2_data" >
                     ...
                     <div dangerouslySetInnerHTML={{ __html: data.data.enterprisebannercontent }} className="section2_data_left"  >
...
So instead of delving into the details of how we do what we do, we’ll topline it for you
               ...
               <div className="section2_data" > 
                ...
                <div className="section2_data_left" dangerouslySetInnerHTML={{ __html: data.data.enterprisefirstcontent }}  >
...
distributed. Our product greatly improves operational performance, boosts profitability, lowers costs and reduces emissions. 
                 ...
                 <div dangerouslySetInnerHTML={{ __html: data.data.enterprisefirstbottomcontent }} className="absol-bottom" >
